...
urlpatterns = [
    ...
    path('<str:context_name>/<str:document_name>/<int:document_version_pk>/', views.view_version),
    path('<str:context_name>/<str:document_name>/<int:document_version_pk>/<int:version_pk_2>/', views.view_diff),
