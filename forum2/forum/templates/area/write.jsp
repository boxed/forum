...
<%@ include file="/htmlhead.jsp" %>
  ...
  <base target="_blank"/>
  <body onload="document.f.subject.focus()">
    ...
    <form method="post" name="f" action="<ww:print value="actionName"/>.action" target="_self">
      ...
      <table class="widetable">
        <ww:textfield name="'subject'" label="text('summary')" maxlength="200" value="subject" template="text-postable.jsp" />
        <ww:textarea name="'body'" label="text('body')" rows="10" template="textarea-postable.jsp" />
        <tr>
          <td></td>
          <td>
