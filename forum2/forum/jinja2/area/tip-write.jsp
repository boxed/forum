...
<ww:else>
		...
		<base target="_blank"/>
		<body onload="document.f.description.focus()">
			...
			<form method="post" name="f" action="<ww:print value="actionName"/>.action#firstnew" target="_self">
				...
				<table class="widetable">
					<ww:textfield name="'genre'" 	label="text('genre')" />
					<ww:textfield name="'title'" 	label="text('title')" />
					<ww:textarea name="'tip'" 		label="text('tip')" rows="10" />
					<ww:textfield name="'rating'" 	label="text('rating')" />
					<tr>
						<td></td>
						<td>
