...
<%@ include file="/htmlhead.jsp" %>
  ...
  <body onLoad="document.f.subject.focus()">
    <center>- <span class="label"><ww:print value="area/name" /></span> - <ww:if test="replyMessage"><ww:text name="'reply'"/></ww:if><ww:else><ww:text name="'speak_up'"/></ww:else> -</center>
    <sk:hr/>
    ...
    <form method="post" name="f" action="<ww:print value="actionName"/>.action#firstnew" target="_self">
      ...
      <table class="widetable">
        ...
        <ww:textarea name="'quote'" label="text('quote')" rows="10" />
        <tr>
          <td></td>
          <td>
